...
static const byte cmd_QID[]   = {0x51, 0x49, 0x44, 0xD6, 0xEA, 0x0D};

// Tabela wskaźników do komend i ich rozmiarów
static const byte* ALL_COMMANDS[] = {cmd_QPIGS, cmd_QMOD, cmd_QPIRI, cmd_QID};
static const int CMD_SIZES[] = {8, 7, 8, 6};
static const char* CMD_NAMES[] = {"QPIGS", "QMOD", "QPIRI", "QID"};
